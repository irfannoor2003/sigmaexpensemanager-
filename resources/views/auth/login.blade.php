<x-app-layout>
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div
            class="absolute w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-pink-500/10 dark:bg-pink-500/20 blur-[100px] sm:blur-[120px] top-[-120px] left-[-120px] rounded-full">
        </div>
        <div
            class="absolute w-[250px] h-[250px] sm:w-[400px] sm:h-[400px] bg-purple-500/10 dark:bg-[#d6007b]/20 blur-[100px] sm:blur-[120px] bottom-[-120px] right-[-120px] rounded-full">
        </div>
    </div>

    {{-- Main Container --}}
    <div
        class="min-h-screen flex items-center justify-center transition-colors duration-500 bg-gray-50 dark:bg-[#050505] overflow-x-hidden p-4">
        <div
            class="relative w-full max-w-md p-8 sm:p-10 rounded-3xl
            ...
            {{-- Logo --}}
            <div
                class="text-2xl sm:text-5xl font-extrabold
...
{{__('app.Please enter your security PIN')}}
            ...
            <form method="POST" action="/login" class="space-y-6" id="pin-form">
                ...
                <div class="flex justify-between gap-2 w-full">
                    @for ($i = 0; $i < 5; $i++)
                        <input type="password" name="pin[]" maxlength="1" class="premium-input pin" required
