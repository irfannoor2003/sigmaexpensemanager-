    ...
    <div class="p-4 sm:p-8 min-h-screen">
        ...
        <div class="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <a href="{{ route('admin.create-user') }}"
                class="w-full sm:w-auto px-4 py-2 bg-pink-500 hover:bg-pink-600 text-white text-xs font-bold rounded-xl shadow-lg shadow-pink-500/20 transition-all flex items-center justify-center gap-2 mt-3 sm:mt-0">
